...
const s = StyleSheet.create({
  ...
  bubbleMe: { alignSelf: 'flex-left', backgroundColor: colors.primary, borderBottomLeftRadius: 4 },
  bubbleOther: { alignSelf: 'flex-right', backgroundColor: colors.navy[700], borderBottomRightRadius: 4 },
